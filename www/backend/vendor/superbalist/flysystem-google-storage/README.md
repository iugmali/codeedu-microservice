 ...
 *    You can use ```putenv('GOOGLE_APPLICATION_CREDENTIALS=/path/to/service-account-storage.json');``` to set the location of your credentials file.
 *
...
$storageClient = new StorageClient([
    'projectId' => 'your-project-id',
    'keyFilePath' => '/path/to/service-account-storage.json',
]);
$bucket = $storageClient->bucket('your-bucket-name');
